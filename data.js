...
export const CIRCUITS = {
  ...
  rooseveltIsland: {
    ...
    eventName:          'Grand Prix of New York',
    lengthKm:           3.4,
    totalLaps:          75,
    trackAbrasiveness:  0.42,
    baseFuelBurnPerLap: 1.00,
    pitLaneTime:        19,
    baseTyreChangeTime: 6,
    fuelRigRate:        0.12,
    sectors: [
      { id: 1, label: 'North bridge',          powerWeight: 0.04, aeroWeight: 0.03, wearWeight: 0.95, fuelWeight: 1.15, baseSectorTime: 24.0 },
      { id: 2, label: 'Island section',        powerWeight: 0.02, aeroWeight: 0.06, wearWeight: 1.50, fuelWeight: 0.70, baseSectorTime: 26.0 },
      { id: 3, label: 'South approach',        powerWeight: 0.02, aeroWeight: 0.05, wearWeight: 1.35, fuelWeight: 0.75, baseSectorTime: 26.0 },
    ],
  },
...
export const SEASON_SCHEDULE = [
  ...
  { round: 17, eventType: 'qualifying', circuitId: 'rooseveltIsland' },
  { round: 17, eventType: 'race',       circuitId: 'rooseveltIsland' },
